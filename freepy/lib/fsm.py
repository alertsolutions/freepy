...
class FiniteStateMachine(object):
  ...
  def __get_actions__(self):
    ...
    '''
    return [callable for callable in self.__get_callables__() if hasattr(callable, '__fsm_action__')]
  ...
  def __get_guards__(self):
    ...
    '''
    return [callable for callable in self.__get_callables__() if hasattr(callable, '__fsm_guard__')]
